...
public class AppStringsTests
{
    public static TheoryData<string, string, string> MainUiKeys => new()
    {
        ...
        { "RegisterUser_Title", "Nowe konto", "New account" },
        { "RegisterUser_RoleUser", "Użytkownik", "User" },
        { "RegisterUser_RoleIt", "IT", "IT" },
        { "RegisterUser_RoleAdmin", "Administrator", "Administrator" },
        { "RegisterUser_Success", "Konto zostało utworzone.", "Account has been created." },
