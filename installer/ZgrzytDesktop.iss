...
[Icons]
Name: "{group}\ZgrzytDesktop"; Filename: "{app}\ZgrzytDesktop.exe"
Name: "{group}\{cm:UninstallProgram,ZgrzytDesktop}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\ZgrzytDesktop"; Filename: "{app}\ZgrzytDesktop.exe"; Tasks: desktopicon
